<div>
    ...
    <div class="grid md:grid-cols-3 gap-6" id="invoice-print">
                            ...
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-neutral-700/40">
                                <td class="py-3 px-4 align-top">
                                    <div class="font-medium">
                                        {{ $item->dish->title ?? ($item->dish->name ?? 'Dish') }}
                                    </div>
        ...
        <div class="space-y-6 print:hidden">
            ...
            {{-- ✅ Cooking time (FIXED minutes) --}}
            <div
                x-data="{
                    status: @entangle('order_status'),
                    minutes: @entangle('cooking_time_min').live,
            ...
            >
                ...
                <div class="space-y-4">
                    <div class="space-y-2">
                        ...
                        {{-- ✅ removed wire:model.defer to avoid conflict --}}
                        <input
                            type="number"
                            min="0"
                            max="600"
                    ...
                    <div x-data="cookTimer({
                        ...
                        endAtMs: @js($cooking_end_at_ms ?? null)
    ...
    {{-- Loading popup — only button actions --}}
