    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <section class="rounded-2xl border border-slate-200/70 bg-white shadow-sm p-6">
            <header class="flex items-center gap-3 mb-6">
                <div
                    class="size-11 rounded-xl grid place-items-center bg-gradient-to-tr from-red-50 to-red-100 text-red-500 ring-1 ring-red-100">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Click the map or drag the pin. Use “Current” for faster
                        pinpointing.</p>
                </div>
            </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1 flex flex-col" x-data="phoneField(@entangle('contact_phone'), @entangle('contact_country'))" wire:ignore>
                ...
                })" x-init="$nextTick(() => init($refs.mapEl))" class="md:col-span-2 space-y-3" wire:ignore.self>
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500 mt-1">Tip: click on the map or drag the pin to fine-tune
                            the address.</p>
                    </div>

                    <div x-ref="mapEl" id="address-map"
                        class="h-80 w-full rounded-xl overflow-hidden ring-1 ring-slate-200/70 z-0" wire:ignore></div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            <label class="font-medium">
                                Delivery Address <span class="text-sm text-gray-600">(Auto filled if address selected
                                    from map)</span>
                            </label>
                            <input type="text"
                                class="w-full focus:outline-none focus:border-none focus:ring-2 focus:ring-customRed-100 rounded mt-1"
                                :disabled="!manualOverride"
                                :class="manualOverride ? '' : 'opacity-80 cursor-not-allowed'" x-model="addressText" />
                            @error('address')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label class="font-medium">City <span class="text-sm text-gray-600">(Auto filled from
                                    map)</span></label>
                            <input type="text"
                                class="focus:outline-none focus:border-none focus:ring-2 focus:ring-customRed-100 rounded w-full mt-1"
                        ...
                        <div>
                            <label class="font-medium">Postcode <span class="text-sm text-gray-600">(Auto filled from
                                    map)</span></label>
                            <input type="text"
                                class="focus:outline-none focus:border-none focus:ring-2 focus:ring-customRed-100 rounded w-full mt-1"
                ...
                <div class="md:col-span-2" x-data="{ note: @entangle('note') }">
                    <div class="flex items-center justify-between">
                        <label class="font-medium">Note to rider <span
                                class="text-sm text-gray-600">(optional)</span></label>
            ...
            {{-- Footer actions --}}
            <div
                class="mt-8 pt-5 border-t border-dashed border-slate-200 flex flex-col md:flex-row items-center justify-end gap-3">
                <div class="flex items-center gap-2">
                    ...
                    init() {
                        ...
                        window.addEventListener('address:label-switched', (e) => {
                            ...
                            if (country) {
                                ...
                                this.iti.setCountry(country.toLowerCase());
                            }
                            if (phone) {
                                this.value = phone;
