...
public function submit()
{
    ...
    try {
        ...
        // Reset
        $this->reset([
            'title','short_description','description','category_id', 'cuisine_id',
            'price','discount_type','discount','vat','sku',
            'track_stock','daily_stock',
            'available_from','available_till','visibility',
            'thumbnail','gallery',
            'meta_title','meta_description','meta_keyword',
            'tags','buns','crusts','addOns','related_dishes',
        ]);
